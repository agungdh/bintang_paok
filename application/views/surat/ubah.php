<div class="app-title">
  <div>
    <h1><i class="fa fa-edit"></i> Bidang</h1>
  </div>
...
<div class="row">
  <div class="col-md-12">
    <div class="tile">
      ...
      <div class="tile-body">
        <form method="post" action="<?php echo base_url('bidang/aksi_ubah'); ?>">
          
          <input type="hidden" name="where[id]" value="<?php echo $data['bidang']->id; ?>">
