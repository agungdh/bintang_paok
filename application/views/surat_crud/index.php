    ...
    <div class="tile">
      <div class="tile-body">
        <div class="tile-title-w-btn">
          ...
          <p><a class="btn btn-primary icon-btn" href="<?php echo base_url('surat_crud/tambah'); ?>"><i class="fa fa-plus"></i>Surat</a></p>
        </div>
          ...
          <tbody>
            ...
            foreach ($this->db->get('surat')->result() as $item) {
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                  <a class="btn btn-primary" href="<?php echo base_url('surat_crud/ubah/' . $item->id); ?>" data-toggle="tooltip" title="Ubah"><i class="fa fa-edit"></i></a>
